...
const Skills = () => {
  return (
    <>
      <section id="skills">
        <span className="skilltitle" data-aos="slide-up" data-aos-delay="500">
          What I do
        </span>
        <span className="skilldesc" data-aos="slide-up" data-aos-delay="600">
        ...
        <div className="skillbars">
          <div className="skillbar" data-aos="zoom-in" data-aos-delay="500">
            ...
            >
              ...
              <p>
                ...
                visually appealing but also highly intuitive and user-friendly.
                I focus on user flows, wireframes, and responsive layouts to
          ...
          <div className="skillbar" data-aos="zoom-in" data-aos-delay="520">
            ...
            >
              ...
              <p>
                I design and build responsive websites that combine modern
                design trends with best practices in performance, accessibility,
                and SEO. From landing pages to complete web platforms, I ensure
                every project is functional and future-ready.
              </p>
            </div>
          </div>
          <div className="skillbar" data-aos="zoom-in" data-aos-delay="540">
            ...
            >
              ...
              <p>
                ...
                which helps me write efficient and optimized code. I regularly
                solve DSA problems on platforms like LeetCode and GeeksforGeeks,
                focusing on time and space complexity. My knowledge includes
